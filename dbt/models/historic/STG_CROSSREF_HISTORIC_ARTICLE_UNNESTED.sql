WITH SRC_CROSSREF_HISTORIC_ARTICLE AS (SELECT *
                                       FROM {{ source('AIRFLOW', 'CROSSREF_HISTORIC_ARTICLE') }}),
     SRC_CROSSREF_ARTICLE_EUTOPIA AS (SELECT *
                                      FROM {{ source('AIRFLOW', 'CROSSREF_ARTICLE_EUTOPIA') }})
...
FROM SRC_CROSSREF_HISTORIC_ARTICLE S
         INNER JOIN SRC_CROSSREF_ARTICLE_EUTOPIA EUTOPIA USING (DOI)
